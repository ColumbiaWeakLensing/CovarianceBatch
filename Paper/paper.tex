...
$\Sigma_\bb{p}=\bb{F}^{-1}$, we find the result~\footnote{The
...
%added last two sentences. -Morgan
%Also: Thick black line draws the eye and looks like the most significant thing on the plot. replace with dotted black line or something else that stands out less.-Morgan
