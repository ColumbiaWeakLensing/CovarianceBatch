...
\item We can recycle a single 240Mpc$/h$ $N$--body simulation to produce an
  ensemble of $O(10^4)$ shear maps whose small scale power spectra and high significance peak counts are statistically independent. The mean feature measured from a shear ensemble, though, could be inaccurate if only one $N$--body simulation is used.
